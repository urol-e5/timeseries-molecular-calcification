...
```{bash}
head ../data/10xbedgraph/ACR-225-TP1_10x.sorted.bedgraph
```
...
```{bash}
head ../output/40-Apul-Gene-Methylation/gene_methylation_ACR-225-TP*_gt10.tsv
```
...
write_tsv(merged_complete, "../output/40-Apul-Gene-Methylation/Apul-gene-methylation_complete.tsv")
```

```{bash}
head ../output/40-Apul-Gene-Methylation/Apul-gene-methylation_complete.tsv
wc -l ../output/40-Apul-Gene-Methylation/Apul-gene-methylation_complete.tsv
```
...
write_tsv(merged_75, "../output/40-Apul-Gene-Methylation/Apul-gene-methylation_75pct.tsv")
```

```{bash}
wc -l ../output/40-Apul-Gene-Methylation/Apul-gene-methylation_75pct.tsv
head ../output/40-Apul-Gene-Methylation/Apul-gene-methylation_75pct.tsv
```
...
# Load data
# ------------------------------------------------------------
df <- read_tsv("../output/40-Apul-Gene-Methylation/Apul-gene-methylation_75pct.tsv")
...
# -------------------------
sample_groups <- str_extract(rownames(mat2_t), "ACR-[0-9]+")
...
# ------------------------------------------------
mat <- read_tsv("../output/40-Apul-Gene-Methylation/Apul-gene-methylation_75pct.tsv") %>%
  column_to_rownames("gene_id") %>%
  as.matrix()
